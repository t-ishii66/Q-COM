...
$$
\vert 100\rangle \xrightarrow{\;\text{CNOT}_{12}\;} \vert 110\rangle, \quad \vert 111\rangle \xrightarrow{\;\text{CNOT}_{12}\;} \vert 101\rangle
$$
...
$$
\vert 0\rangle \vert 00\rangle \xrightarrow{\;H_1\;} \frac{\vert 0\rangle + \vert 1\rangle}{\sqrt{2}} \vert 00\rangle, \quad \vert 0\rangle \vert 11\rangle \xrightarrow{\;H_1\;} \frac{\vert 0\rangle + \vert 1\rangle}{\sqrt{2}} \vert 11\rangle
$$

$$
\vert 1\rangle \vert 10\rangle \xrightarrow{\;H_1\;} \frac{\vert 0\rangle - \vert 1\rangle}{\sqrt{2}} \vert 10\rangle, \quad \vert 1\rangle \vert 01\rangle \xrightarrow{\;H_1\;} \frac{\vert 0\rangle - \vert 1\rangle}{\sqrt{2}} \vert 01\rangle
$$
...
| $\vert 11\rangle$ | $-\beta\vert 0\rangle + \alpha\vert 1\rangle$ | $XZ\vert\psi\rangle$ |
...
$$
XZ\vert\psi\rangle = X(\alpha\vert 0\rangle - \beta\vert 1\rangle) = \alpha\vert 1\rangle - \beta\vert 0\rangle = -\beta\vert 0\rangle + \alpha\vert 1\rangle \quad \checkmark
$$
...
ベル状態 $\vert\Phi^+\rangle = \frac{\vert 00\rangle + \vert 11\rangle}{\sqrt{2}}$ は以下の手順で生成できる（ノート01, 02参照）：
