...
$$
\vert 00\rangle \overset{ H \otimes I }{\longrightarrow} \frac{\vert 0\rangle + \vert 1\rangle}{\sqrt{2}} \vert 0\rangle = \frac{\vert 00\rangle + \vert 10\rangle}{\sqrt{2}} \overset{ \text{CNOT} }{\longrightarrow} \frac{\vert 00\rangle + \vert 11\rangle}{\sqrt{2}} = \vert\Phi^+\rangle
$$
