...
量子ビットを計算基底で **測定** すると：
- 確率 $\lvert\alpha\rvert^2$ で $|0\rangle$ が得られる
- 確率 $\lvert\beta\rvert^2$ で $|1\rangle$ が得られる
...
- 確率 $\left\lvert\frac{1}{\sqrt{2}}\right\rvert^2 = \frac{1}{2}$ で $|0\rangle$
- 確率 $\left\lvert\frac{1}{\sqrt{2}}\right\rvert^2 = \frac{1}{2}$ で $|1\rangle$
